...
export const PlayerDot: FunctionComponent<IProps> = ({
  ...
  if (dead) {
    return (
      <svg
        ...
        aria-hidden="true"
        role="img"
        className="iconify iconify--fxemoji z-20 absolute fill-red-400"
  ...
  return (
    <div
      className={`${dead ? "bg-amber-950!" : "rounded-full"} w-2 h-2 absolute z-21 ${color} border border-solid border-blue-200`}
      style={{ left, top }}
    />
  );
};
